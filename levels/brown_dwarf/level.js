const brownDwarf = {
  ...
  platform: {
    ...
    doorCompanionMeshNames: ["Circle_door_0.001", "Circle_glass_0"],
    doorCompanionMeshPattern: "^circle_door_glass$",
    doorCollisionMeshNames: ["COL_door"],
    ignoredCollisionMeshNames: ["COL_front"],
    doorInteractionProxyScale: 2.9,
    doorOpenInteractionProxyHeightScale: 1.15,
    doorInteractionProxyDepth: 0.28,
    brownDwarfWindowShadows: true,
    shadowMapSize: 1024,
    windowShadowMapSize: 1024,
    ...
    floorProps: [
      {
        id: "floor-astronaut-helmet",
        label: "Astronaut Helmet",
        modelUrl: "./assets/astronaut_helmet.glb",
        maxSize: 0.34,
        position: [0.24, 0, -0.92],
        rotationDegrees: [68, -18, 64],
        floorOffset: 0.006,
        pickupRange: 1.75,
        swatch: "#d8d5c8",
      },
  ...
  debrisField: {
    ...
    radius: 620,
    nearFragmentCount: 440,
    maxActiveRocks: 320,
    initialRockGraceRadius: 2.2,
    protectedSpawnRadius: 2.2,
    shipGraceRadius: 2.2,
    shipGraceTrajectoryMargin: 0.45,
    ...
    coOrbitFraction: 0.8,
    relativeDriftSpeed: 0.01125,
    fastRelativeDriftSpeed: 0.65,
    rockBackwardDriftSpeed: 0.3375,
    rockStreamCellDistance: 30,
    rockStreamCycleSeconds: 16,
    rockStreamReplacementFraction: 0.14,
    rockStreamSpawnMinDistance: 5.5,
    rockStreamLifetimeSeconds: [60, 92],
    ...
    rockNormalStrength: 1.85,
    rockTextureNormalStrength: 10.5,
    rockSpecularPower: 18,
