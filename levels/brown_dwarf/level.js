const brownDwarf = {
  ...
  debrisField: {
    ...
    radius: 620,
    nearFragmentCount: 180,
    maxActiveRocks: 220,
    initialRockGraceRadius: 18,
    guaranteedFrontRock: true,
    guaranteedFrontRockDistance: 8,
    guaranteedFrontRockSizeMeters: 18,
    rockRenderDistance: 150,
    rockClumpCount: 4,
    rockClumpRadius: 8,
    rockClumpDistance: 62,
    rockStableDistance: 82,
    rockFadeStart: 96,
    rockFadeEnd: 148,
    ...
    interceptClumpCount: 4,
    interceptClumpDistance: [7, 38],
    rockDensityGain: 2.0,
    rockDensityThreshold: 0.15,
    rockDensityExponent: 2.45,
    nearRockFlowSpeed: 0,
